...
public class FirstLogin_Page extends BasePage
{
	public FirstLogin_Page() {
	...
	@AndroidFindBy(id = "com.unifynd.lite.frt.pro:id/etFirstName")
	private MobileElement enterFirstName;
	
	@AndroidFindBy(id = "com.unifynd.lite.frt.pro:id/etLastName")
	private MobileElement enterLastName;
	
	@AndroidFindBy(xpath = "//*[@text='Continue to Home']")
	...
	{
		sendkeys(enterFirstName, PropertyUtility.getreaddata("First_Name"));
		ExtentListeners.test.log(Status.INFO, "Entering First Name" );
		sendkeys(enterLastName, PropertyUtility.getreaddata("Last_Name"));
		ExtentListeners.test.log(Status.INFO, "Entering Last Name" );
		click(continueBtn);
		ExtentListeners.test.log(Status.INFO, "Succesfully Enter your Full Name" );
	}
}
